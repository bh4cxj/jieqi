...
$jieqiCollect['sitename']='在线漫画高ID';  //站名
...
$jieqiCollect['sort']='';
//封面图片
$jieqiCollect['cartoonimage']=array('left'=>'<a href="/html/book$/" ><img alt="~"  src="', 'right'=>'" ></a>', 'middle'=>'~~~~');
...
//***************************************************************************
//取得分卷图片数http://www.zxmh.net/jspage/3477/42982.js
//***************************************************************************
...
echo $col_image_path[$params['fromcid']].jieqi_cartoon_decode64($col_volume_images[$params['fromvid']][$params['frompid']-1]);
	//返回网址

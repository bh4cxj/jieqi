...
function loadSet()
{
	...
	chaptercontent.style.cssText=fonttype.options[fonttype.selectedIndex].value+';line-height: 150%';
	chaptercontent.style.color=txtcolor.options[txtcolor.selectedIndex].value;
}

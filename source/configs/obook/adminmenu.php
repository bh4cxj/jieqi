...
$jieqiAdminmenu['obook'][] = array('layer' => 0, 'caption' => '电子书共享', 'command'=>$GLOBALS['jieqiModules']['obook']['url'].'/admin/obookshare.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['obook'][] = array('layer' => 0, 'caption' => '代理销售统计', 'command'=>$GLOBALS['jieqiModules']['obook']['url'].'/share/sharestat.php', 'target' => 0, 'publish' => 1);

$jieqiAdminmenu['obook'][] = array('layer' => 0, 'caption' => '内容共享平台', 'command'=>$GLOBALS['jieqiModules']['obook']['url'].'/share/sharecontent.php', 'target' => 0, 'publish' => 1);
?>
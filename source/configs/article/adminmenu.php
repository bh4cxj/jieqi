...
$jieqiAdminmenu['article'][] = array('layer' => 0, 'caption' => '伪静态页面生成', 'command'=>$GLOBALS['jieqiModules']['article']['url'].'/admin/makefake.php', 'target' => 0, 'publish' => 1);
...
$jieqiAdminmenu['article'][] = array('layer' => 0, 'caption' => '催更管理', 'command'=>$GLOBALS['jieqiModules']['article']['url'].'/admin/cuigeng.php', 'target' => 0, 'publish' => 1);
?>
...
<div class="gridtop">'.$this->_tpl_vars['articletitle'].' [<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/masterpage.php">全部文章</a>] [<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/masterpage.php?display=author">原创文章</a>] [<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/masterpage.php?display=poster">转载文章</a>] [<a href="'.$this->_tpl_vars['jieqi_modules']['article']['url'].'/masterpage.php?display=agent">代管文章</a>]</div>
<table class="dingyuebiaoge">
                  <thead>
                    <tr>
                      <th class="shuming">书名</th>
                      <th class="zhuangtai">作者</th>
                      <th class="scs">收藏数</th>
                      <th class="zhgxsj">最后更新时间</th>
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
   ...
   <tr>
                      ...
                      <td class="caozuo"><a href="'.$this->_tpl_vars['article_static_url'].'/articlemanage.php?id='.$this->_tpl_vars['articlerows'][$this->_tpl_vars['i']['key']]['articleid'].'">作品管理</a></td>
                    </tr>';
}
echo '
					                   </tbody>
...
<div id="footer">
	<p>Copyright ? 2010-2013 潮流原创文学网 All rights reserved Powered by.宇宙之音（北京）科技有限公司</p>
	<p>潮流原创版权所有，未经许可不得转载。 潮流征稿邮箱：SKY_editor@126.com 京ICP备13020644号-1 关于我们</p>

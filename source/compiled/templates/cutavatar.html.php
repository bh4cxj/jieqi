<?php
echo '<script language="javascript" type="text/javascript" src="'.$this->_tpl_vars['jieqi_url'].'/scripts/drag.js"></script>
...
<div class="c_head">说明：为了页面整洁，本站统一头像图片大小，上传头像图片后请在下面选择裁剪位置，并提交才能正式保存成功。</div>
...
<tr>
<td><img style="margin-top: 5px; cursor:pointer;"  src="'.$this->_tpl_vars['jieqi_url'].'/images/ui/_h.gif" alt="图片缩小" onmouseover="this.src=\''.$this->_tpl_vars['jieqi_url'].'/images/ui/_c.gif\'" onmouseout="this.src=\''.$this->_tpl_vars['jieqi_url'].'/images/ui/_h.gif\'" onclick="imageresize(false)" /></td>
<td><img id="img_track" style="width: 250px; height: 18px; margin-top: 5px" src="'.$this->_tpl_vars['jieqi_url'].'/images/ui/track.gif" /></td>
<td><img style="margin-top: 5px; cursor:pointer;" src="'.$this->_tpl_vars['jieqi_url'].'/images/ui/+h.gif" alt="图片放大"  onmouseover="this.src=\''.$this->_tpl_vars['jieqi_url'].'/images/ui/+c.gif\'" onmouseout="this.src=\''.$this->_tpl_vars['jieqi_url'].'/images/ui/+h.gif\'" onclick="imageresize(true)" /></td>
</tr>
</table>

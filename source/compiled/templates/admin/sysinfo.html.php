...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
  <tr>
    <td class="odd">'.$this->_tpl_vars['sysinfos'][$this->_tpl_vars['i']['key']]['name'].'</td>
    <td class="even"><span class="'.$this->_tpl_vars['sysinfos'][$this->_tpl_vars['i']['key']]['state'].'">'.$this->_tpl_vars['sysinfos'][$this->_tpl_vars['i']['key']]['value'].'</span></td>
    <td class="odd"><span class="'.$this->_tpl_vars['sysinfos'][$this->_tpl_vars['i']['key']]['state'].'">'.$this->_tpl_vars['sysinfos'][$this->_tpl_vars['i']['key']]['note'].'</span></td>
  </tr>
';
}
echo '

...
echo '<ul class="ulitem">
  <li><a href="'.$this->_tpl_vars['url_articlelist'].'">х╚╡©ндуб</a></li>
';
...
for($this->_tpl_vars['i']['index'] = 0; $this->_tpl_vars['i']['index'] < $this->_tpl_vars['i']['loops']; $this->_tpl_vars['i']['index']++){
	...
	echo '
  <li><a href="'.$this->_tpl_vars['sortrows'][$this->_tpl_vars['i']['key']]['url_sort'].'">'.$this->_tpl_vars['sortrows'][$this->_tpl_vars['i']['key']]['sortname'].'</a></li>
';
}
echo '
</ul>';

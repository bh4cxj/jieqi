...
<div class="fl">论坛首页</a>'.$this->_tpl_vars['forumguide'].'</div>
<div class="fr"><a href="'.$this->_tpl_vars['url_search'].'">论坛搜索</a></div>
<div class="cb"></div>
</div>
...
for($this->_tpl_vars['j']['index'] = 0; $this->_tpl_vars['j']['index'] < $this->_tpl_vars['j']['loops']; $this->_tpl_vars['j']['index']++){
	...
	echo '
    <tr>
        <td align="center" valign="middle" class="odd"><img src="'.$this->_tpl_vars['jieqi_modules']['forum']['url'].'/images/nonew_big.gif" border="0" /></td>
        <td valign="middle" class="even">
		[ <a href="'.$this->_tpl_vars['jieqi_modules']['forum']['url'].'/topiclist.php?fid='.$this->_tpl_vars['forums'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['forumid'].'"><strong>'.$this->_tpl_vars['forums'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['forumname'].'</strong></a> ]
		<br />
		&nbsp;&nbsp;&nbsp;&nbsp;'.$this->_tpl_vars['forums'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['desc'].'
		</td>
        <td align="center" valign="middle" class="odd">'.$this->_tpl_vars['forums'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['topics'].'</td>
        <td align="center" valign="middle" class="even">'.$this->_tpl_vars['forums'][$this->_tpl_vars['i']['key']][$this->_tpl_vars['j']['key']]['posts'].'</td>

...
if($_GET['confirm'] != 1){
	echo '<font color="red">注意：</font><br>1.6版本里面JAR电子书增加了分卷生成功能，并且保存的目录结构有所变化，本程序用户更新JAR保存目录。<br>需要注意的是本程序仅仅更新之前生成的整本小说JAR，如果您希望新版里面使用分卷生成JAR，则建议直接删除之前的JAR目录，然后到网站后台批量重新生成<br><br><a href="'.basename($_SERVER['PHP_SELF']).'?confirm=1">点击这里开更新JAR目录</a><br><br>';
	exit;
}

echo '                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        ';
echo '开始更新JAR目录，请耐心等待...<br>';
ob_flush();
flush();

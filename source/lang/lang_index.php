 ...
 * @author     $Author: juny $
 * @version    $Id: lang_index.php 193 2008-11-25 02:52:44Z juny $
 */

$jieqiLang['system']['index']=1; //表示本语言包已经包含

$jieqiLang['system']['make_sindex_success']='恭喜您，静态首页已经重新生成！';
$jieqiLang['system']['make_sindex_failure']='对不起，静态首页生成失败，清检查 %s 是否有可写的权限！';
...
$jieqiLang['system']['make_static_failure']='对不起，静态页面生成失败，清检查 %s 是否有可写的权限！';
?>
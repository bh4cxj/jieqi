 ...
 * @author     $Author: juny $
 * @version    $Id: lang_collect.php 228 2008-11-27 06:44:31Z juny $
 */
...
$jieqiLang['article']['rule_image_areacleandec']='<br />按照图片内的矩形坐标，抹去该区域内容。一个矩形用四个数值表示(用“,”分隔)，分别是矩形左上角X，Y和左下角X,Y。当X，Y大于0时候表示从图片左上角开始加多少像素，当X，Y小于0时候表示从图片右下角开始减多少像素。多个区域用“|”分割。<br />例如：本项设置成“1,1,100,50|-100,-50,-1,-1”，分别表示左上角和右下角100*50的矩形区域。';

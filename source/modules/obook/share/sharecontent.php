...
$jieqiTpl->assign('url_sharecontent', $obook_dynamic_url.'/share/sharecontent.php');
...
$jumppage->setlink($obook_dynamic_url.'/share/sharecontent.php'.$pagelink, false, true);
$jieqiTpl->assign('url_jumppage',$jumppage->whole_bar());
$jieqiTpl->setCaching(0);
$jieqiTset['jieqi_contents_template'] = $jieqiModules['obook']['path'].'/templates/share/sharecontent.html';

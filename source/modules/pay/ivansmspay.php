 ...
 * 埃文手机短信-支付界面
 *
 * 埃文手机短信-支付界面 (http://www.ivansms.com)
 * 
 * 调用模板：/modules/pay/templates/ivansmspay.html
 * 
 * @category   jieqicms
 * @package    pay
 * @copyright  Copyright (c) Hangzhou Jieqi Network Technology Co.,Ltd. (http://www.jieqi.com)
 * @author     $Author: juny $
 * @version    $Id: ivansmspay.php 234 2008-11-28 01:53:06Z juny $
 */
...
$jieqiTpl->assign('url_confirm', $jieqiModules['pay']['url'].'/ivansmsconfirm.php');
$local_domain_url=(empty($_SERVER['HTTP_HOST'])) ? '' : 'http://'.$_SERVER['HTTP_HOST'];
$jieqiTpl->assign('url_login', JIEQI_USER_URL.'/login.php?do=submit&jumpurl='.urlencode($local_domain_url.'/modules/pay/ivansmspay.php'));
...
$tmpfile=$jieqiModules['pay']['path'].'/templates/ivansmspay.html';

 ...
 * @author     $Author: juny $
 * @version    $Id: lang_paycard.php 234 2008-11-28 01:53:06Z juny $
 */

$jieqiLang['pay']['paycard']=1; //表示本语言包已经包含
...
$jieqiLang['pay']['paycard_payemoney_neednum']='冲值金额必须是一个数字！';
...
$jieqiLang['pay']['card_is_pay']='对不起，该卡号已经被使用，请不要重复冲值！';

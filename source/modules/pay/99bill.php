 ...
 * @author     $Author: juny $
 * @version    $Id: 99bill.php 326 2009-02-04 00:26:22Z juny $
 */
...
if(isset($_REQUEST['egold']) && is_numeric($_REQUEST['egold']) && $_REQUEST['egold']>0){
	...
	*/
	...
	if(!$paylog_handler->insert($paylog)) jieqi_printfail($jieqiLang['pay']['add_paylog_error']);
		...
		$jieqiTset['jieqi_contents_template'] = $jieqiModules['pay']['path'].'/templates/99bill.html';

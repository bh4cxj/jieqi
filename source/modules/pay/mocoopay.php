 ...
 * 奥创手机支付-支付界面
 * 
 * 调用模板：/modules/pay/templates/mocoopay.html
 * 
 * @category   jieqicms
 * @package    pay
 * @copyright  Copyright (c) Hangzhou Jieqi Network Technology Co.,Ltd. (http://www.jieqi.com)
 * @author     $Author: juny $
 * @version    $Id: mocoopay.php 234 2008-11-28 01:53:06Z juny $
 */
...
$jieqiTpl->assign('url_confirm', $jieqiModules['pay']['url'].'/mocooconfirm.php');
$local_domain_url=(empty($_SERVER['HTTP_HOST'])) ? '' : 'http://'.$_SERVER['HTTP_HOST'];
$jieqiTpl->assign('url_login', JIEQI_USER_URL.'/login.php?do=submit&jumpurl='.urlencode($local_domain_url.'/modules/pay/mocoopay.php'));
...
$tmpfile=$jieqiModules['pay']['path'].'/templates/mocoopay.html';

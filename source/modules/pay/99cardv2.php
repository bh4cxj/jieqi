 ...
 * 快钱神州行第二版-提交处理
 *
 * 快钱神州行第二版-提交处理 (http://www.99billv2.com)
 * 
 * 调用模板：/modules/pay/templates/99cardv2.html
 * 
 * @category   jieqicms
 * @package    pay
 * @copyright  Copyright (c) Hangzhou Jieqi Network Technology Co.,Ltd. (http://www.jieqi.com)
 * @author     $Author: juny $
 * @version    $Id: 99cardv2.php 326 2009-02-04 00:26:22Z juny $
 */
...
if(isset($_REQUEST['egold']) && is_numeric($_REQUEST['egold']) && $_REQUEST['egold']>0){
	...
	if(!$paylog_handler->insert($paylog)) jieqi_printfail($jieqiLang['pay']['add_paylog_error']);
		...
		$jieqiTset['jieqi_contents_template'] = $jieqiModules['pay']['path'].'/templates/99cardv2.html';

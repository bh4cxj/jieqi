 ...
 * 博客的热评文章显示
 * 
 * 调用模板：$jieqiModules['space']['path'].'/templates/bloglistreview.html
 * 
 * @category   jieqicms
 * @package    space
...
$criteria->setSort('review_num');
$criteria->setOrder('desc,up_time desc');
$pagenum = 20;
...
$jieqiTset['jieqi_contents_template'] = $jieqiModules['space']['path'].'/templates/bloglistreview.html';
